...
#
# Which archive a file belongs to is recorded in its `locator["archive"]` tag
...
function _fetch_dataset(::CMRxRecon2024, e::DatasetEntry, dest::AbstractString; progress::Bool, verify::Bool)
    archive = get(e.locator, "archive", "training")
    spec = get(_ARCHIVES, archive, nothing)
    ...
    span = _zip_span(e)
    sf = Int(e.locator["start_frag"]::Integer)
    ef = Int(e.locator["end_frag"]::Integer)
